...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/user/balance/withdraw": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "номер счёта и сумма баллов к списанию в счёт оплаты",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.UserBalanceWithdrawRequest"
                        }
                    },
                    {
                        "type": "string",
    ...
    "definitions": {
        ...
        "api.UserBalanceWithdrawRequest": {
            "type": "object",
            "properties": {
                "order": {
                    "type": "string",
        ...
        "api.Withdraw": {
            ...
            "properties": {
                ...
                "processed_at": {
                    "type": "string",
                    "example": "2025-07-05T16:35:32+03:00"
                },
                "sum": {
                    "type": "number",
                    "example": 500
